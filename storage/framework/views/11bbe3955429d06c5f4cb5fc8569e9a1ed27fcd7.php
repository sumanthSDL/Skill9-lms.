<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        ...
        <?php endif; ?>
        <a class="dropdown-item" href="<?php echo e(url('instructor/skills')); ?>"><i
            class="feather icon-add mr-2"></i><?php echo e(__('Add Skills')); ?></a>
    </div>
</div>
...
<!-- delete Model ended -->
<?php /**PATH C:\xampp\htdocs\eclass\resources\views/admin/allinstructor/action.blade.php ENDPATH**/ ?>